...
import './AndroidMobileRegister2.dart';

class AndroidMobileSettingsAlarm extends StatelessWidget {
  AndroidMobileSettingsAlarm({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(22.0, 274.0),
            child: Text(
              'What days should the Alarm go off?',
              style: TextStyle(
                      ...
                      Transform.translate(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                width: 1.0, color: const Color(0x46707070)),
                          ),
                        ),
                      ),
                      Transform.translate(
                      ...
                      Transform.translate(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                width: 1.0, color: const Color(0x8f707070)),
                          ),
                        ),
                      ),
                    ],
