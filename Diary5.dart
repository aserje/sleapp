...
class Diary5 extends StatelessWidget {
  Diary5({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                ...
                Transform.translate(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          width: 1.0, color: const Color(0x5c707070)),
                    ),
                  ),
                ),
                Transform.translate(
          ...
          Transform.translate(
            offset: Offset(11.0, 282.0),
            child: SpecificRectClip(
              rect: Rect.fromLTWH(0, 0, 67, 291),
          ...
          Transform.translate(
            offset: Offset(-19.0, -1.0),
            child: BlendMask(
              blendMode: BlendMode.screen,
              opacity: 0.8500000238418579,
              region: Offset(81.0, 282.0) & Size(259.0, 261.0),
              child: Stack(
                children: <Widget>[
                  Transform.translate(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [
                            const Color(0xd907add7),
                            const Color(0xd904576c)
                          ],
                          stops: [0.0, 1.0],
                        ),
                      ),
...
const String _svg_rjo6tt =
    '<svg viewBox="217.0 283.0 25.0 25.0" ><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.0"><stop offset="0.0" stop-color="#ff07add7"  /><stop offset="1.0" stop-color="#ff04576c"  /></linearGradient></defs><path transform="translate(217.0, 283.0)" d="M 12.5 0 C 19.4035587310791 0 25 5.596441268920898 25 12.5 C 25 19.4035587310791 19.4035587310791 25 12.5 25 C 5.596441268920898 25 0 19.4035587310791 0 12.5 C 0 5.596441268920898 5.596441268920898 0 12.5 0 Z" fill="url(#gradient)" fill-opacity="0.85" stroke="none" stroke-width="1" stroke-opacity="0.85" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_uc4a1z =
    '<svg viewBox="178.0 342.0 25.0 25.0" ><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.0"><stop offset="0.0" stop-color="#ff07add7"  /><stop offset="1.0" stop-color="#ff04576c"  /></linearGradient></defs><path transform="translate(178.0, 342.0)" d="M 12.5 0 C 19.4035587310791 0 25 5.596441268920898 25 12.5 C 25 19.4035587310791 19.4035587310791 25 12.5 25 C 5.596441268920898 25 0 19.4035587310791 0 12.5 C 0 5.596441268920898 5.596441268920898 0 12.5 0 Z" fill="url(#gradient)" fill-opacity="0.85" stroke="none" stroke-width="1" stroke-opacity="0.85" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_qs8qn5 =
    '<svg viewBox="139.0 401.0 25.0 25.0" ><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.0"><stop offset="0.0" stop-color="#ff07add7"  /><stop offset="1.0" stop-color="#ff04576c"  /></linearGradient></defs><path transform="translate(139.0, 401.0)" d="M 12.5 0 C 19.4035587310791 0 25 5.596441268920898 25 12.5 C 25 19.4035587310791 19.4035587310791 25 12.5 25 C 5.596441268920898 25 0 19.4035587310791 0 12.5 C 0 5.596441268920898 5.596441268920898 0 12.5 0 Z" fill="url(#gradient)" fill-opacity="0.85" stroke="none" stroke-width="1" stroke-opacity="0.85" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_3ojq1t =
    '<svg viewBox="334.0 401.0 25.0 25.0" ><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.0"><stop offset="0.0" stop-color="#ff07add7"  /><stop offset="1.0" stop-color="#ff04576c"  /></linearGradient></defs><path transform="translate(334.0, 401.0)" d="M 12.5 0 C 19.4035587310791 0 25 5.596441268920898 25 12.5 C 25 19.4035587310791 19.4035587310791 25 12.5 25 C 5.596441268920898 25 0 19.4035587310791 0 12.5 C 0 5.596441268920898 5.596441268920898 0 12.5 0 Z" fill="url(#gradient)" fill-opacity="0.85" stroke="none" stroke-width="1" stroke-opacity="0.85" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_8aihbh =
    '<svg viewBox="139.0 460.0 25.0 25.0" ><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.0"><stop offset="0.0" stop-color="#ff07add7"  /><stop offset="1.0" stop-color="#ff04576c"  /></linearGradient></defs><path transform="translate(139.0, 460.0)" d="M 12.5 0 C 19.4035587310791 0 25 5.596441268920898 25 12.5 C 25 19.4035587310791 19.4035587310791 25 12.5 25 C 5.596441268920898 25 0 19.4035587310791 0 12.5 C 0 5.596441268920898 5.596441268920898 0 12.5 0 Z" fill="url(#gradient)" fill-opacity="0.85" stroke="none" stroke-width="1" stroke-opacity="0.85" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
