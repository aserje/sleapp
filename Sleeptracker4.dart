...
class Sleeptracker4 extends StatelessWidget {
  Sleeptracker4({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(-11.0, -305.0),
            child: Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(41.0, 450.0),
                  child:
                      // Adobe XD layer: 'dane-wetton-t1NEMSm…' (shape)
                      Container(
                    width: 104.5,
                    height: 104.5,
                ...
                Transform.translate(
                  offset: Offset(164.0, 450.0),
                  child:
                      // Adobe XD layer: 'dane-wetton-AkSJQne…' (shape)
                      Container(
                    width: 104.5,
                    height: 104.0,
                    decoration: BoxDecoration(
                ...
                Transform.translate(
                  offset: Offset(287.0, 450.0),
                  child:
                      // Adobe XD layer: 'dane-wetton-4s2FBzn…' (shape)
                      Container(
                    width: 104.5,
                    height: 104.5,
                    decoration: BoxDecoration(
          ...
          Transform.translate(
            offset: Offset(-1682.0, -2731.0),
            child: Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(1839.0, 3095.0),
                  child:
                      // Adobe XD layer: 'bruce-mars-HHXdPG_e…' (shape)
                      Container(
                    width: 106.0,
                    height: 105.5,
                    decoration: BoxDecoration(
                ...
                Transform.translate(
                  offset: Offset(1964.0, 3095.0),
                  child:
                      // Adobe XD layer: 'bruce-mars-gJtDg6Wf…' (shape)
                      Container(
                    width: 104.5,
                    height: 104.5,
                    decoration: BoxDecoration(
                ...
                Transform.translate(
                  offset: Offset(1684.0, 2957.0),
                  child: Stack(
                    children: <Widget>[
                      Transform.translate(
                        offset: Offset(28.0, 138.0),
                        child:
                            // Adobe XD layer: 'bruce-mars-oLStrTTM…' (shape)
                            Container(
                          width: 105.5,
                          height: 105.5,
                          decoration: BoxDecoration(
