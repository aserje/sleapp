...
class Sleeptracker3 extends StatelessWidget {
  Sleeptracker3({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(153.0, 162.0),
            child: SpecificRectClip(
              rect: Rect.fromLTWH(0, 0, 207, 94),
              child: UnconstrainedBox(
                ...
                child: Container(
                  ...
                  child: GridView.count(
                    ...
                    crossAxisSpacing: 20,
                    crossAxisCount: 2,
                    childAspectRatio: 1.0532,
                    children: [
                      {},
                      {},
                    ].map((map) {
                      return Transform.translate(
                        offset: Offset(-52.0, -307.0),
                        child: Stack(
                          children: <Widget>[
                            Transform.translate(
                              offset: Offset(52.0, 307.0),
          ...
          Transform.translate(
            offset: Offset(2.0, -21.0),
            child: Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(-26.27, 441.4),
                  child: BlendMask(
          ...
          Transform.translate(
            offset: Offset(33.0, 377.0),
            child: SpecificRectClip(
              rect: Rect.fromLTWH(0, 0, 99, 94),
              child: UnconstrainedBox(
                alignment: Alignment.topLeft,
                child: Container(
                  width: 99,
                        ...
                        child: Stack(
                          children: <Widget>[
                            Transform.translate(
                              offset: Offset(52.0, 307.0),
                              child:
                                  // Adobe XD layer: 'gabriele-diwald-Kwi…' (shape)
                                  Container(
                                width: 99.0,
                                height: 94.0,
                                decoration: BoxDecoration(
          ...
          Transform.translate(
            offset: Offset(141.0, 377.0),
            child: SpecificRectClip(
              rect: Rect.fromLTWH(0, 0, 219, 94),
              child: UnconstrainedBox(
                alignment: Alignment.topLeft,
                child: Container(
                  width: 218,
                    ...
                    children: [
                      ...
                      return Transform.translate(
                        ...
                        child: Stack(
                          children: <Widget>[
                            Transform.translate(
                              offset: Offset(62.0, 307.0),
                              child:
                                  // Adobe XD layer: 'casey-horner-4rDCa5…' (shape)
                                  Container(
                                width: 99.0,
                                height: 94.0,
                                decoration: BoxDecoration(
