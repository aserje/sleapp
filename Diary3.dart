    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(22.0, 237.0),
            child: Text(
              'Lena, how bad is your\nback pain today?',
              style: TextStyle(
          ...
          Transform.translate(
            offset: Offset(168.0, 431.0),
            child:
                // Adobe XD layer: 'change_history-whit…' (group)
                Stack(
              children: <Widget>[
                Transform.translate(
...
const String _svg_7xtl6b =
    '<svg viewBox="-4.0 0.0 41.0 37.0" ><path  d="M 0 0 L 37 0 L 37 37 L 0 37 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(-6.0, -4.0)" d="M 18.5 10.83312511444092 L 29.04349899291992 29.375 L 7.956500053405762 29.375 L 18.5 10.83312511444092 M 18.5 4 L 2 33 L 35 33 L 18.5 4 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_i3utr7 =
    '<svg viewBox="22.0 392.0 317.0 25.0" ><path transform="translate(22.0, 392.0)" d="M 12.5 0 L 304.5 0 C 311.403564453125 0 317 5.596440315246582 317 12.5 C 317 19.40356063842773 311.403564453125 25 304.5 25 L 216.5722045898438 25 L 12.5 25 C 5.596440315246582 25 0 19.40356063842773 0 12.5 C 0 5.596440315246582 5.596440315246582 0 12.5 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.0"><stop offset="0.0" stop-color="#ff07add7"  /><stop offset="0.390581" stop-color="#dd19a8cc" stop-opacity="0.87" /><stop offset="1.0" stop-color="#5206c7f7" stop-opacity="0.32" /></linearGradient></defs><path transform="translate(22.0, 392.0)" d="M 12.5 0 L 160 0 L 160 25 L 12.5 25 C 5.596440315246582 25 0 19.40356063842773 0 12.5 C 0 5.596440315246582 5.596440315246582 0 12.5 0 Z" fill="url(#gradient)" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
